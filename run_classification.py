...
def run_experiments(args, train_loader, val_loader, test_loader, model_path, output_path):
    ...
    for idx in range(args.num_trial):
        ...
        auroc_mean = multilabel_auroc(p_test, y_test_int, num_labels=args.num_classes, average="macro").cpu().numpy()
        auroc_individual = multilabel_auroc(p_test, y_test_int, num_labels=args.num_classes, average=None).cpu().numpy()
